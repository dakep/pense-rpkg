...
cat(sprintf('[![Build Status](https://travis-ci.com/dakep/pense-rpkg.svg?branch=%s)](https://travis-ci.com/dakep/pense-rpkg)',
            branch_name))
```
<!-- end badges -->
...
Version 2.x, release September 2020, introduces many new features and improved computational speed.
The changes, however, make the package incompatible with previous versions.
The [migration guide](https://dakep.github.io/pense-rpkg/articles/migration_guide.html) helps migrating existing code to new versions of the package.
