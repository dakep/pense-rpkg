 ...
 *      item 2: Numeric vector with the residuals
 */
RcppExport SEXP C_elnet_weighted(SEXP Xtr, SEXP y, SEXP weights, SEXP coefs, SEXP nobs, SEXP nvar,
								 SEXP alpha, SEXP lambda, SEXP maxIt, SEXP eps, SEXP centering,
								 SEXP warm, SEXP enAlgorithm);
...
RcppExport SEXP C_pscs_en(SEXP Xtr, SEXP y, SEXP nobs, SEXP nvar, SEXP alpha, SEXP lambda,
                          SEXP maxIt, SEXP eps, SEXP centering, SEXP enAlgorithm);
 ...
 *      item 2: The value of the objective function for each initial estimate
 */
RcppExport SEXP C_pen_s_reg(SEXP Xtr, SEXP y, SEXP nobs, SEXP nvar, SEXP coefs, SEXP control);
