...
This is again to ensure reproducibility of the CV, but also to make the estimated prediction performance more comparable across different values of the hyper-parameters.
...
Here we see the combination of hyper-parameters `alpha=0.75` and `exponent=1` (in object `fit_exp_1`) leads to the best prediction accuracy, but the models are all based on more than 12 predictors.
...
```{r, eval=FALSE, include=FALSE}
save(fit_075_10repl, fit_075_3repl, fit_075_mae, fit_exp_1, fit_exp_2,
